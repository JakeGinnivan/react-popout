  ...
  render() {
      ...
      return (
        <div>
          ...
          <Popout title='Test' onClosing={this.popoutClosed} url='/demoPopup.html'>
            <div>
          ...
          <div>
            <strong>Example: Using url <a style={{ textDecoration: 'underline', color: 'blue', cursor: 'pointer' }} onClick={this.popout}>(pop window out)</a></strong>
          </div>
        </div>
      );
